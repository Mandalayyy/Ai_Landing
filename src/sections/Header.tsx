  ...
  return (
    <header className="py-4 border-b border-white/15 md:border-none sticky top-0 z-10  ">
      ...
      <div className="container">
        <div className="realative flex justify-between items-center md:border border-white/15 rounded-xl md:p-2.5 max-w-2xl mx-auto">
        <div className="absolute backdrop-blur inset-0 -z-10 hidden md:block"></div>
          <div>
