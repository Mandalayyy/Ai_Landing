...
export const Hero = () => {
  ...
  style={{
    ...
    {/* Start Planet */}
    <div className="absolute h-64 w-64 md:h-96 md:w-96 planet-shadow-bg"></div>
   {/* End Planet */}
   ...
   {/* Start Ring 1 */}
    ...
    className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] rounded-full border opacity-20 border-white top-1/2 left-1/2">
      <div className="absolute h-2 w-2 top-1/2 left-0 bg-white rounded-full -translate-x-1/2 -translate-y-1/2"></div>
    ...
    <div className="container relative mt-16">
      <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white text-transparent text-center bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] bg-clip-text">AI SEO</h1>
